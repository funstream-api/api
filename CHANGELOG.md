...
### Funstream
- **admin**
    - [`/api/support/ban`](admin.md#Отключить-возможность-задавать-вопросы), [`/api/support/channels`](admin.md#Список-последних-вопросов) добавлены запросы отключения возможности задавать вопросы поддержке и списка последних вопросов пользователя
