...
- **common**
    ...
    - [`/api/content`](common.md#Список-элементов-контента) для элементов контента добавлено поле `slug`, содержащее имя элемента в ссылке на него(например /room/<slug>, /stream/<slug>), поправлен состав обязательных и необязательных полей элемента контента
- **room**
