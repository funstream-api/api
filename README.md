...
- [**Общее**](common.md)
    ...
    - [**Майлстоуны**](common.md#Майлстоуны)
        - [`POST` `P` `/api/schedule/get` Список майлстоунов](common.md#Список-майлстоунов)
        - [`POST` `A` `/api/schedule/my` Майлстоуны пользователя](common.md#Майлстоуны-пользователя)
