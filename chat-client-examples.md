...
<script type='text/javascript'>
    ...
    var socket = io('wss://funstream.tv:443/socket.io/?EIO=3&transport=websocket', {
...
var socket = io.connect('wss://funstream.tv:443/socket.io/?EIO=3&transport=websocket', {transports: ['websocket']});
...
```C#
socket = IO.Socket("wss://funstream.tv:443/socket.io/?EIO=3&transport=websocket", new IO.Options { Transports = ImmutableList.Create("websocket") });
